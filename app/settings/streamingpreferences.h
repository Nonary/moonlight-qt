...
public:
    ...
    Q_PROPERTY(bool enableBlackFrameInsertion MEMBER enableBlackFrameInsertion NOTIFY enableBlackFrameInsertionChanged)
...
signals:
    ...
    void enableBlackFrameInsertionChanged();
